...
class TestNodeIdStringRepresentation:
    ...
    def test_node_id_short_format(self):
    ...
    def test_node_id_short_format_uses_8_chars(self):
        ...
        result = node_id.to_short_string()
...
class TestNodeIdParsing:
    ...
    def test_from_string_invalid_format_too_few_parts(self):
        """Test validation rejects format with too few parts."""
        with pytest.raises(ValueError, match="Invalid NodeId format"):
            NodeId.from_string("heading:intro")

    def test_from_string_invalid_hash_length_too_short(self):
    ...
    def test_from_string_invalid_hash_length_too_long(self):
...
class TestNodeIdRoundTrip:
    ...
    def test_round_trip_from_string_to_str(self):
...
class TestNodeIdEquality:
    ...
    def test_equality_uses_first_16_characters(self):
    ...
    def test_equality_requires_matching_type(self):
    ...
    def test_equality_requires_matching_hint(self):
    ...
    def test_hash_uses_first_16_characters(self):
...
class TestNodeIdFromNode:
    ...
    def test_from_node_generates_full_64_char_hash(self):
    ...
    def test_from_node_generates_hint(self):
    ...
    def test_from_node_deterministic(self):
        ...
        id1 = NodeId.from_node(node1)

        clear_node_id_cache()

        id2 = NodeId.from_node(node2)
